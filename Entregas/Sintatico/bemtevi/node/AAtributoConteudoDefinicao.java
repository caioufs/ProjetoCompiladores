...
public final class AAtributoConteudoDefinicao extends PConteudoDefinicao
{
    private PAtributo _atributo_;

    public AAtributoConteudoDefinicao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAtributoConteudoDefinicao(
    ...
    {
        ((Analysis) sw).caseAAtributoConteudoDefinicao(this);
    }

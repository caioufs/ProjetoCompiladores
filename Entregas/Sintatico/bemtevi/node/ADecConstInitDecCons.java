...
public final class ADecConstInitDecCons extends PDecCons
{
    ...
    public Object clone()
    {
        return new ADecConstInitDecCons(
    ...
    {
        ((Analysis) sw).caseADecConstInitDecCons(this);
    }

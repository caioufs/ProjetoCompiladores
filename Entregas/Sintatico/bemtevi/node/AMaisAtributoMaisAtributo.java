...
public final class AMaisAtributoMaisAtributo extends PMaisAtributo
{
    private TPonto _ponto_;
    private TId _id_;

    public AMaisAtributoMaisAtributo()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaisAtributoMaisAtributo(
    ...
    {
        ((Analysis) sw).caseAMaisAtributoMaisAtributo(this);
    }

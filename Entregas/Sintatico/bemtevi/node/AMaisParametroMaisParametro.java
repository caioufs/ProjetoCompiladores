...
public final class AMaisParametroMaisParametro extends PMaisParametro
{
    private TPipe _pipe_;
    private PParametro _parametro_;

    public AMaisParametroMaisParametro()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaisParametroMaisParametro(
    ...
    {
        ((Analysis) sw).caseAMaisParametroMaisParametro(this);
    }

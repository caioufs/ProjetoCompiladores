...
public final class ADecConsConteudoBloco extends PConteudoBloco
{
    private PDecCons _decCons_;

    public ADecConsConteudoBloco()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecConsConteudoBloco(
    ...
    {
        ((Analysis) sw).caseADecConsConteudoBloco(this);
    }
